    ...
    <MobileAppLayout title="Dashboard">
      <section className="rounded-[2rem] border border-white/5 bg-zinc-900/60 p-6 backdrop-blur-xl">
        ...
        <p className="mt-4 text-sm leading-6 text-white/50">
          Central privada da NoFvce Crew. Aqui ficam status da crew, garagem,
          eventos, membros e drops oficiais.
        </p>
      ...
      <section className="mt-6 grid grid-cols-3 gap-3">
        ...
        <StatCard label="Cars" value="08" />
        <StatCard label="Meets" value="04" />
      </section>
      ...
      <section className="mt-6 rounded-[2rem] border border-white/5 bg-zinc-900/60 p-5 backdrop-blur-xl">
        ...
        <p className="mt-3 text-sm leading-6 text-white/50">
          A NoFvce está em fase de formação. O foco agora é selecionar membros,
          organizar os carros e preparar o primeiro conteúdo oficial.
        </p>
      </section>
      ...
      <section className="mt-6 rounded-[2rem] border border-white/5 bg-zinc-900/60 p-5 backdrop-blur-xl">
        ...
        <p className="mt-4 text-sm leading-6 text-white/50">
          Encontro noturno fechado para fotos low light, lineup e conteúdo de
          lançamento da crew.
        </p>
      </section>
